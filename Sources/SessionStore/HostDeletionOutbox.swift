...
enum HostDeletionOutboxError: Error, Equatable, LocalizedError {
...
struct HostDeletionOutbox {
	...
	@discardableResult
	mutating func insert(_ serverID: String) throws -> Bool {
		if let loadError { throw loadError }
	...
	mutating func remove(_ serverID: String) throws {
		if let loadError { throw loadError }
