...
final class HostJumpHostServerIdTests: XCTestCase {
	...
	func testCodableRoundTripWithNonNilJumpHostServerId() throws {
		var h = SSHHost(name: "n", hostname: "h", port: 22,
		                username: "u", credential: .password)
		h.jumpHostId = UUID(uuidString: "11111111-2222-3333-4444-555555555555")
		h.jumpHostServerId = "server-abc-123"
		let data = try JSONEncoder().encode(h)
		let decoded = try JSONDecoder().decode(SSHHost.self, from: data)
		XCTAssertEqual(decoded.jumpHostId, UUID(uuidString: "11111111-2222-3333-4444-555555555555"))
	...
	func testEncoderOmitsKeysWhenJumpHostReferencesAreNil() throws {
		...
		XCTAssertFalse(json.contains("jumpHostId"),
		               "nil jumpHostId should be omitted, got: \(json)")
