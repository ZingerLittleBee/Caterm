...
- Further ad-hoc signed #59 GUI coverage passed remote-to-remote relay and
  ...
  writes. Task-window and application-closure acceptance remain part of #59.
