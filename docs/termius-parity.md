...
- The live [Termius pricing comparison](https://termius.com/pricing), checked
  again on 2026-07-24. Starter still includes SSH, SFTP, autocomplete, and
...
- Separate `make run-app` runs produced and launched Apple Development-signed
  applications. Those signed builds completed startup automation, desktop
  SFTP, and Workspace accessibility, restoration, split-layout, and
  multi-surface acceptance against disposable localhost fixtures.
